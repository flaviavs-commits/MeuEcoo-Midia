...
app.use((req, res, next) => {
  ...
  const csp = "default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'none'; img-src 'self' data: blob: https:; media-src 'self' https: blob:; connect-src 'self' https:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; script-src 'self' 'sha256-BHrVdk+m3SmGDZOUJzhGyUvbBwDSONLXVLFgrlQoC+0=' 'sha256-StHcaWdc2/HgrGZXxKE0LfihFx9NPi1XasBlgsGWdeU=' 'sha256-y3U0zUge8Tuly9bqC6ykJdxX+F408naGdnaxNi05mGQ=' 'sha256-PCiVuiJOVzTaly8PMUCHDSCNKHu9h6iIPgrZZHP45kQ=' 'sha256-zv7xLDnuAkFMFe41o1VjUq//tTEDdG/KyxOin3XyaW8='"
